...
### ▶ Now — Phase 8b approved with conditions; fix round running.
...
| 8b Birthday notifications | 🟡 **APPROVED WITH CONDITIONS** (review of `5e3457a`) — fix round: M1 int4 `owner_id` guard, m1 C87 wording ×3, m2 zone single-source, m3/n1/n2; then mutation re-run + gate | ✅ | ✅ **PASS** (`parity-phase-8b.md`) | 🟡 **Approved w/ conditions** | ✅ `ba-phase-8b-birthdays.md` — concerns resolved by **Q51**/**Q52** | **C71**, **D39**, **D48**, **D49**; **C87**, **C88**, **C89** open; runbook 3a/3a-bis delete 1497/2142; task 2142 deadline 14 November 2026 |
