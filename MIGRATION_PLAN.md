...
| **Storage in development (m3)** | ✅ **Decided — keep v1's behaviour** (Q50): development environments use the real bucket whenever Google credentials are present; this host has none (measured). No change in the fix round. |
