...
### ▶ Now — Phase 8b implemented; alignment and parity checks running.
...
| 8b Birthday notifications | 🟡 **IMPLEMENTED** — `5e3457a` on `feat/phase-8b-birthdays`; gate re-measured independently; awaiting `business-analyst` + `manual-tester` | ✅ | ⬜ | ⬜ | 🟡 checking (Q47–Q49 decided) | **C71**, **D39**, **D48**, **D49**; 4 open questions Q-8b-1..4 (`docs/phase-8b-deviations.md` §6); task 2142 deadline 14 November 2026 |
