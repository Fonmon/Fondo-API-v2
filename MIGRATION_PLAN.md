...
| 9 Cutover, hstore→jsonb | 🟡 **STAGE 2a APPROVED W/ CONDITIONS** — `5d019d9` approved, `204aa88` (Release B) approved with doc conditions; **cutover NO-GO until C97** (Release A tag + independent gate) | ✅ stage 2a | ⬜ | 🟡 Approved w/ conditions | ✅ two BA notes | C91–C96 ✅; **C97** 🔴 blocks cutover; **C98**, **C99** docs; stage 2b blocked on step 6 (correct) |
