...
### ▶ Now — Phase 8b: analyst done, parity PASS; `nestjs-reviewer` next.
...
| 8b Birthday notifications | 🟡 **PARITY PASS** — `5e3457a`; gate re-measured independently; awaiting `nestjs-reviewer` | ✅ | ✅ **PASS** (`parity-phase-8b.md`) | ⬜ | ✅ `ba-phase-8b-birthdays.md` — concerns resolved by **Q51**/**Q52** | **C71**, **D39**, **D48**, **D49**; **C87** open (doc wording); runbook 3a/3a-bis now delete 1497/2142; task 2142 deadline 14 November 2026 |
