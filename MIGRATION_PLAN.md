...
| **Docs ✅** | **D41** registered (parse-side integer precision — seen in Phase 5 as L2, seen again as P6-F5, registered neither time); **D37** fourth site; **P6-F5** split render/parse; **C77(iii)**'s falsified sentence moved onto the cell where it is true; `scripts/parity/reset-clone.sh` committed 755; false-green **#23**. |
