...
### ▶ Now — Phase 8b implemented; analyst done, operator answered Q51–Q52; parity round running.
...
| 8b Birthday notifications | 🟡 **IMPLEMENTED** — `5e3457a`; gate re-measured independently; `business-analyst` done; awaiting `manual-tester`, then `nestjs-reviewer` | ✅ | ⬜ | ⬜ | ✅ `ba-phase-8b-birthdays.md` — concerns resolved by **Q51**/**Q52** | **C71**, **D39**, **D48**, **D49**; **C87** open (doc wording); runbook 3a/3a-bis now delete 1497/2142; task 2142 deadline 14 November 2026 |
