...
### ▶ Now — Phase 8 closed; Phase 8b next.
...
| **Phase 8b — Birthday notifications** | 🟡 **Next.** **D48** next birthday not yet missed (Q47), **D39** skip a departed member at send time while the chain keeps rolling (Q48), **D49** recipients resolved at send time (Q49); C71. |
...
| 8b Birthday notifications | 🟡 **NEXT** — dispatching `nestjs-developer` | ⬜ | ⬜ | ⬜ | ✅ Q47–Q49 decided | **C71**, **D39**, **D48**, **D49**; task 2142 deadline 14 November 2026 |
